...
class StaticValue {
  ...
  static String datetimeconverter(String datetimeutc) {
    // Parse the input datetime in UTC format
    DateTime parseDate = DateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parse(datetimeutc, true);

    // Convert to local time (optional, remove if not needed)
